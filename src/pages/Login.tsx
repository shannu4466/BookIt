  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <Button
          variant="ghost"
          className="text-white hover:bg-purple-500/20 hover:text-white mb-4"
          onClick={() => navigate('/')}
        >
              ...
              <TabsContent value="login">
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Button
                        ...
                        variant="ghost"
                        size="sm"
                        className="absolute right-0 top-0 h-full px-3 text-gray-400 hover:text-black hover:bg-gradient-to-r hover:from-purple-600 hover:to-pink-600"
                  ...
                  <div className="text-end">
                    <button className="text-white" type="button" onClick={() => navigate("/reset-password")}>Forgot Password...?</button>
                  </div>
                  ...
                  <div className="relative">
                    ...
                    <div className="relative flex justify-center text-xs uppercase">
                      <span className="bg-gradient-to-br from-slate-950 via-purple-950 to-slate-950 px-2 text-gray-400">
                        Or continue with
                      </span>
                    </div>
                  </div>
                  ...
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full border-purple-500/30 text-black hover:bg-purple-500/20 hover:text-white"
